...
Запускается вручную для обновления карты.
По задумке авторов в собранной версии игры карта обновляется автоматически, все ключевые предметы и квесты спавнятся рандомно.
"""
